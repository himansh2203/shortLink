...
async function writeStore(data) {
    ...
    await __TURBOPACK__imported__module__$5b$externals$5d2f$fs$2f$promises__$5b$external$5d$__$28$fs$2f$promises$2c$__cjs$29$__["default"].writeFile(DATA_FILE, JSON.stringify(data, null, 2), "utf8");
}
...
async function POST(req) {
    ...
    if (!url || !validateUrl(url)) return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
        error: "Invalid or missing url (include http/https)"
    }, {
        status: 400
    });
    const store = await readStore();
    if (code) {
        if (!CODE_REGEX.test(code)) return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            error: "Custom code must be 6-8 alphanumeric"
        }, {
            status: 400
        });
        if (store.find((s)=>s.code === code)) return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            error: "Code exists"
        }, {
            status: 409
        });
        ...
        }while (store.find((s)=>s.code === code))
    }
    const created = {
        code,
        url,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__f7146194._.js.map
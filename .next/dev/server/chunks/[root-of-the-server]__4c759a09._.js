...
async function GET(req, context) {
    ...
    let item = store.find((s)=>s.code === code);
    if (!item) {
        const lower = String(code).toLowerCase();
        item = store.find((s)=>String(s.code).toLowerCase() === lower);
    }
    if (!item) {
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            error: "Not found"
    ...
    return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].redirect(target, 302);
}
}),
];

//# sourceMappingURL=%5Broot-of-the-server%5D__4c759a09._.js.map
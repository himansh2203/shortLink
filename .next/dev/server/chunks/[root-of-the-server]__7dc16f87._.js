...
"[project]/app/api/links/[code]/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(_req, context) {
    ...
    const item = store.find((s)=>s.code === code || String(s.code).toLowerCase() === code.toLowerCase());
...
async function DELETE(_req, context) {
    ...
    const store = await readStore();
    const idx = store.findIndex((s)=>s.code === code || String(s.code).toLowerCase() === code.toLowerCase());
...
//# sourceMappingURL=%5Broot-of-the-server%5D__7dc16f87._.js.map
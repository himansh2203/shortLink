...
async function createLink(code, url) {
    ...
    if (links.find((l)=>l.code === code)) {
        const err = new Error("Code exists");
        err.code = "EXISTS";
        throw err;
    }
...
"[project]/app/[code]/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(request, context) {
    ...
    const link = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getLinkByCode"])(String(code));
    if (!link) {
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            error: "Not found"
        }, {
    ...
    try {
        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["incrementClick"])(String(code));
    } catch  {
    /* ignore increment failures */ }
    return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].redirect(link.url);
}
}),
];

//# sourceMappingURL=%5Broot-of-the-server%5D__7cc3784b._.js.map